...
[[https://vimeo.com/195028882][If the video above doesn't play, you can see it by clicking this link]]
   ...
   :END:
** DONE Odyssey Road Trip                                       :video:libby:
...
** DONE Libby Piano Duet                                  :video:libby:piano:
...
** DONE Libby Plays Joplin                                :video:libby:piano:
   CLOSED: [2019-02-24 Sun]
   :PROPERTIES:
...
** DONE Libby Plays Scarlatti                             :libby:piano:video:
   CLOSED: [2019-02-24]
   :PROPERTIES:
...
{{< youtube iVDxMp2k0iY >}}
** DONE Libby and Nargol play Bach                        :libby:piano:video:
   CLOSED: [2019-04-28 Sun 18:36]
   :PROPERTIES:
   :EXPORT_FILE_NAME: libby-and-nargol-play-bach
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :description libby-and-nargol-play-bach
   :END:
...
{{< youtube mN-O9pykhTY>}} 
** TODO The Adventures of Kayla the Cat                         :libby:story:
   :PROPERTIES:
   :EXPORT_FILE_NAME: the-adventures-of-kayla-the-cat
   :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :description the-adventures-of-kayla-the-cat
   :END:
...
** TODO How to build a Serverless API with Go and AWS Lambda
   :PROPERTIES:
...
** TODO How to upload files to Amazon s3 using NodeJs, Lambda and Api Gateway
   :PROPERTIES:
