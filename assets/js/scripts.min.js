...
window.onload=function(){"use strict";imagesLoaded(document.querySelector("#image-container"),function(e){var n=document.querySelector(".grid");new Masonry(n,{itemSelector:".grid-item",columnWidth:".grid-sizer",percentPosition:!0})});var e=document.getElementById("js-mobile-menu"),n=document.getElementById("navigation-menu");e.addEventListener("click",function(){n.classList.toggle("show")})};
