...
document.getElementById("js-mobile-menu").addEventListener("click",function(){var e=document.getElementById("navigation-menu");e.classList.contains("show")&&(e.classList.remove("show"),e.classList.add("hide"))}),imagesLoaded(document.querySelector("#image-container"),function(e){var t=document.querySelector(".grid");new Masonry(t,{itemSelector:".grid-item",columnWidth:".grid-sizer",percentPosition:!0})});
