...
$("#navigation-menu").removeClass("show"),$("#js-mobile-menu").on("click",function(e){e.preventDefault(),$("#navigation-menu").slideToggle(function(){$("#navigation-menu").is(":hidden")&&$("#navigation-menu").removeAttr("style")})}),$("#container").imagesLoaded(function(){$("img").addClass("item")}),$("article.post #container img, article.post-full #container img").each(function(){var e=$(this).attr("alt"),i=$(this).attr("src");if(""!=e){var t=($(this).width(),$(this).height()),n=$(this).position(),a=n.top+t-26;$("<div class='img-caption' href='"+i+"'><em>"+e+"</em> <i class='icon-link-ext'></i></div>").css({"margin-bottom":"2em",top:a+"px",left:"0",width:"100%",clear:"both",height:"40px",display:"block"}).insertAfter(this)}}),$("a.gallery-grid").click(function(){$(".gallery").removeClass("container-one_up").addClass("container-three_up")});var container=document.querySelector("article.post-three_up #container"),msnry=new Masonry(container,{itemSelector:"img"});$(".gallery").magnificPopup({delegate:"a",type:"image",gallery:{enabled:!0},verticalFit:!0,showCloseBtn:!1});var filtersButton=$("#filter-none").hide();
!function e(t){var a={prefix:"",suffix:" ago",seconds:"less than a minute",minute:"about a minute",minutes:"%d minutes",hour:"about an hour",hours:"about %d hours",day:"a day",days:"%d days",month:"about a month",months:"%d months",year:"about a year",years:"%d years"},r=function(e,t){return a[e]&&a[e].replace(/%d/i,Math.abs(Math.round(t)))},n=function(e){if(e){e=e.replace(/\.\d+/,""),e=e.replace(/-/,"/").replace(/-/,"/"),e=e.replace(/T/," ").replace(/Z/," UTC"),e=e.replace(/([\+\-]\d\d)\:?(\d\d)/," $1$2"),e=new Date(1e3*e||e);var t=new Date,n=.001*(t.getTime()-e)>>0,o=n/60,u=o/60,s=u/24,i=s/365;return a.prefix+(45>n&&r("seconds",n)||90>n&&r("minute",1)||45>o&&r("minutes",o)||90>o&&r("hour",1)||24>u&&r("hours",u)||42>u&&r("day",1)||30>s&&r("days",s)||45>s&&r("month",1)||365>s&&r("months",s/30)||1.5>i&&r("year",1)||r("years",i))+a.suffix}},o=document.getElementsByClassName("timeago");for(var u in o){var s=o[u];"object"==typeof s&&(s.innerHTML=n(s.getAttribute("title")||s.getAttribute("datetime")))}setTimeout(e,6e4)}();